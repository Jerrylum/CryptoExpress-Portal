 ...
 */
export async function getAllData(contract: Contract, prefix: string): Promise<void>  {
    try {
 ...
 */
export async function getData(contract: Contract, prefix: string, uuid: string): Promise<void> {
    try {
...
export async function signRouteProposal(contract: Contract, routeUuid: string, entityHashId: string, signature: string): Promise<void> {
    try {
